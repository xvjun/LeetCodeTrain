...
public class Main3 {
    ...
    public static void main(String[] args) {
        ...
        String filename1 = "src/main/java/Graph/WeightedGraph/txt/testG1.txt";
        int V1 = 8;

        String filename2 = "src/main/java/Graph/WeightedGraph/txt/testG2.txt";
        int V2 = 250;

        String filename3 = "src/main/java/Graph/WeightedGraph/txt/testG3.txt";
        int V3 = 1000;

        String filename4 = "src/main/java/Graph/WeightedGraph/txt/testG4.txt";
        int V4 = 10000;
...
//        System.out.println( filename5 + " load successfully.");
        ...
        System.out.println("Test for G1: " + (endTime-startTime) / 1000000000.0 + "s.");

        startTime = System.nanoTime();
        LazyPrimMST<Double> lazyPrimMST2 = new LazyPrimMST<Double>(g2);
        endTime = System.nanoTime();
        System.out.println("Test for G2: " + (endTime-startTime) / 1000000000.0 + "s.");

        startTime = System.nanoTime();
        LazyPrimMST<Double> lazyPrimMST3 = new LazyPrimMST<Double>(g3);
        endTime = System.nanoTime();
        System.out.println("Test for G3: " + (endTime-startTime) / 1000000000.0 + "s.");

        startTime = System.nanoTime();
        LazyPrimMST<Double> lazyPrimMST4 = new LazyPrimMST<Double>(g4);
        endTime = System.nanoTime();
        System.out.println("Test for G4: " + (endTime-startTime) / 1000000000.0 + "s.");
